<template>
    <b-navbar toggleable="md" type="dark" class="bg-primary">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">examenpracticocinco</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <!--<b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/cargos">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cargos')">Cargos</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/sucursales">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.sucursales')">Sucursales</span>
                    </b-dropdown-item>
